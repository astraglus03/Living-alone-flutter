...
class EditRoomPostScreen extends ConsumerStatefulWidget {
  const EditRoomPostScreen({Key? key}) : super(key: key);

  @override
  ConsumerState<EditRoomPostScreen> createState() => _EditPostScreenState();
}

class _EditPostScreenState extends ConsumerState<EditRoomPostScreen> {

  @override
  Widget build(BuildContext context) {
    final state = ref.watch(editRoomPostProvider);
    print('${state.deposit} ${state.monthlyRent}, ${state.maintenanceFee}');
  ...
  Widget _buildListTile1(String title, String rentType, VoidCallback onTap, EditRoomPostState state) {
  ...
  Widget _buildListTile2(String title, String rentType, VoidCallback onTap, EditRoomPostState state) {
